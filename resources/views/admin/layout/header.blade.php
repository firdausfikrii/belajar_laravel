                            ...
                            <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor"
                                ...
                                <path fill-rule="evenodd"
                                    d="M18 10a8 8 0 11-16 0 8 8
                                        0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014
                                        0zm-2 4a5 5 0 00-4.546
                                        2.916A5.986 5.986 0 0010
                                        16a5.986 5.986 0 004.546-2.084A5 5 0 0010
                                        11z"
                                    clip-rule="evenodd"></path>
                            </svg>
                            My Profile
                            ...
                            <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor"
                                ...
                                <path fill-rule="evenodd"
                                    d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98
                                        ...
                                        2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379
                                        1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836
                                        2.942-.734
                                        ...
                                        1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000
                                        6z"
                                    clip-rule="evenodd"></path>
                            </svg>
                            Settings
